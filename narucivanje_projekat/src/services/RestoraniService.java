...
public class RestoraniService {
	...
	@GET
	@Path("/nadjiRestoran/{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public Restoran dobaviRestoran(@PathParam("id") String id) {
		System.out.println("ID JE:" + id);
		RestoraniDAO dao = (RestoraniDAO) ctx.getAttribute("restoraniDAO");
		return dao.dobaviRestoran(id);
	}
